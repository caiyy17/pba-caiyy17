...
void wdw_spring_3d(
  ...
  // with respect to the positions of the two end points.
    // dw[0] is the gradient of the energy with respect to the position of the first end point
    // dw[1] is the gradient of the energy with respect to the position of the second end point
